...
/**
 * Create or edit service modal form.
 * @param {Object} props - Modal form props from ModalWrapper.
 * @param {"create"|"edit"} props.mode - Form mode.
 * @param {string} [props._id] - Service id for edit mode.
 * @param {string} [props.name] - Initial service name.
